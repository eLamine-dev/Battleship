...
`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAAA;GACG,eAAe;AAClB;;AAEA;GACG,aAAa;GACb,mBAAmB;GACnB,uBAAuB;AAC1B;;AAEA;GACG,aAAa;GACb,sDAAsD;GACtD,eAAe;GACf;kDAC+C;AAClD;;AAEA;GACG,aAAa;GACb,mDAAmD;GACnD,oBAAoB;GACpB,wBAAwB;GACxB,YAAY;AACf;;AAEA;GACG,sBAAsB;GACtB,aAAa;GACb,mBAAmB;GACnB,uBAAuB;AAC1B;;AAEA;GACG,iCAAiC;AACpC;;AAEA;GACG,uBAAuB;AAC1B;;AAEA;GACG,aAAa;GACb,QAAQ;GACR,uBAAuB;GACvB,WAAW;AACd;;AAEA;GACG,kBAAkB;GAClB,WAAW;GACX,OAAO;AACV;;AAEA;GACG,YAAY;GACZ,WAAW;GACX,wCAAwC;AAC3C;;AAEA;GACG,aAAa;GACb,uBAAuB;GACvB,sBAAsB;GACtB,QAAQ;AACX;;AAEA;GACG,YAAY;AACf;;AAEA;GACG,qBAAqB;AACxB","sourcesContent":[":root {\n   --board-size: 0;\n}\n\nbody {\n   display: flex;\n   align-items: center;\n   justify-content: center;\n}\n\n.board {\n   display: grid;\n   grid-template-columns: repeat(var(--board-size), 50px);\n   column-gap: 1px;\n   /* transform-origin: bottom center;\n   transform: perspective(600px) rotatex(45deg); */\n}\n\n.board-column {\n   display: grid;\n   grid-template-rows: repeat(var(--board-size), 50px);\n   align-items: stretch;\n   justify-content: stretch;\n   row-gap: 1px;\n}\n\n.square {\n   background-color: aqua;\n   display: flex;\n   align-items: center;\n   justify-content: center;\n}\n\n.square:hover {\n   background-color: rgb(72, 0, 255);\n}\n\n.square:not([occupied-by='null']) {\n   background-color: black;\n}\n\n.ship {\n   display: grid;\n   gap: 1px;\n   justify-content: center;\n   z-index: 10;\n}\n\n.ship.placed {\n   position: absolute;\n   z-index: 10;\n   left: 0;\n}\n\n.ship-square {\n   height: 50px;\n   width: 50px;\n   background-color: rgba(255, 0, 0, 0.515);\n}\n\n.ships-container {\n   display: flex;\n   align-items: flex-start;\n   flex-direction: column;\n   gap: 3px;\n}\n\n.hide {\n   opacity: 40%;\n}\n\n.drag-over {\n   background-color: red;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
class GamePage extends HTMLElement {
   ...
   renderShipPositioningPage() {
      ...
      (0,lit_html__WEBPACK_IMPORTED_MODULE_0__.render)((0,lit_html__WEBPACK_IMPORTED_MODULE_0__.html)`${humanSide}${this.buildShipsContainer()}`, document.body);
   ...
   renderBattlePage() {
      ...
      // let computerSide = this.buildOneSideContainer(this.game.computerBoard);
      (0,lit_html__WEBPACK_IMPORTED_MODULE_0__.render)((0,lit_html__WEBPACK_IMPORTED_MODULE_0__.html)`${humanSide}${computerSide}`, document.body);
   }
   ...
   buildShipsContainer() {
      ...
      shipsContainer.classList.add('ships-container');
      this.game.humanBoard.ships.forEach((ship) =>
         shipsContainer.appendChild(new _shipView__WEBPACK_IMPORTED_MODULE_1__["default"](ship))
      );
      return shipsContainer;
   }

   buildOneSideContainer(board) {
      return (0,lit_html__WEBPACK_IMPORTED_MODULE_0__.html)` <div class="side-container ${board.player.type}">
...
/* harmony import */ var _dom_gamePage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom/gamePage */ "./src/dom/gamePage.js");
...
document.addEventListener('DOMContentLoaded', () => {
   ...
   const myGamePage = new _dom_gamePage__WEBPACK_IMPORTED_MODULE_1__["default"](myGame);
